...
class Carro:
   ...
   # FUNÇÕES DA CLASSE CARRO
    ...
    def desligar(self): # DESLIGAR CARRO
        if self.ligado:
            self.ligado = False
    ...
    def acelerar(self): # ACELERAR CARRO
        if self.ligado:
    ...
    def frear(self): # REDUZIR A VELOCIDADE
        if self.ligado:
            if self.velocidade == 0:
    ...
    def abastecer(self, quantidade): # ABASTECER O CARRO
...
# CRIAÇÃO DOS CARRROS
car1 = Carro("Cybertruck", 2024, "Prata", 100, False, 0)
